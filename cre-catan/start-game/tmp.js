...
var onLogTrigger = (runtime2, log) => {
  runtime2.log(`Log detected from ${log.address} chain`);
  runtime2.log(`Log data: ${JSON.stringify(log.data)}`);
  runtime2.log(`Log topics: ${JSON.stringify(log.topics)}`);
  runtime2.log(`Log address: ${log.address}`);
  runtime2.log(`Log block number: ${log.blockNumber}`);
  runtime2.log(`Log block hash: ${log.blockHash}`);
